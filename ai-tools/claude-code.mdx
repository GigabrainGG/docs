...
Claude Code is Anthropic's official CLI tool for AI-assisted development. Use it to build trading bots and market analysis tools powered by Gigabrain's Intelligence Collective.
...
<Steps>
  ...
  <Step title="Configure Claude Code">
    ...
    - **Macro Analyst**: DXY, VIX, yields, Fed Funds, S&P 500, risk regime
    - **Microstructure Analyst**: Funding rates, OI, liquidations, long/short ratios
    - **Fundamentals Analyst**: TVL, protocol revenue, active users, token metrics
    - **Market State Analyst**: Fear & Greed, narratives, sentiment, regime shifts
    - **Price Movement Analyst**: Technical analysis, EMAs, RSI, MACD, trade setups
    - **Trenches Analyst**: Micro-cap tokens, social momentum, KOL mentions
    - **Polymarket Analyst**: Prediction markets, odds, volume, resolution dates
...
Gigabrain's Price Movement Analyst. Compare technical indicators and

...
- **Investment Funds**: Performance fees from multiple AI-managed funds
...
- **Terminal Access**: Two-tiered access model
...
- **Trading Fees**: Revenue from direct trading execution (Subject to change)
...
- **API & Data Services**: Enterprise and institutional offerings
...
- Active participation in governance voting and proposals

...
description: "Agent Skill for querying Gigabrain's Brain for real-time crypto market intelligence"
icon: "brain"
---

The `gigabrain-intel` skill gives any [Agent Skills](https://agentskills.io/)-compatible agent access to Gigabrain's Brain API — a single endpoint (`POST /v1/chat`) for real-time crypto market intelligence covering macro, microstructure, fundamentals, sentiment, technicals, micro-caps, and prediction markets.

...
The `brain` skill gives any [Agent Skills](https://agentskills.io/)-compatible agent access to Gigabrain's Brain API — a single endpoint (`POST /v1/chat`) for real-time crypto market intelligence covering macro, microstructure, fundamentals, sentiment, technicals, micro-caps, and prediction markets.

<Card title="View on GitHub" icon="github" href="https://raw.githubusercontent.com/GigabrainGG/agent-skills/refs/heads/main/skills/brain.md">
  Raw SKILL.md file
</Card>

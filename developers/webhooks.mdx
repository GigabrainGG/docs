...
description: "Receive Radar insights and Alpha trade signals at your own endpoint"
icon: "plug"
---

Webhooks let you stream Gigabrain-generated market intelligence into your own automation stack.

Configure endpoints in the dashboard at **Profile -> Integrations -> Webhooks**. Each endpoint can subscribe to Radar insights, Alpha trade signals, or both.

...
Alpha events are created when an Alpha trade signal is generated. The `signal` object mirrors the trade signal JSON contract so downstream automation can build directly on it.
...
```json
{
  ...
  "data": {
    ...
    "timeframe": "1H",
    "source": "radar",
    "radar_insight_id": "radar-insight-123",
    "confidence": 82,
    "status": "open",
    ...
    "signal": {
      ...
      "related_radar_insights": ["radar-insight-123"],
      "confidence": 82,
      "confidence_drivers": [
        "Clean level reclaim",
...
Radar events are created when a Radar insight is generated. The `raw` object mirrors the insight JSON content.
...
```json
{
  ...
  "data": {
    ...
    "metadata": {
      "source_tweet": {
        "tweet_id": "tweet-123",
        "author_username": "gigabrain",
        "created_at": "2026-04-27T10:54:00.000Z",

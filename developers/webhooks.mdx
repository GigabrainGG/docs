...
<Note>
This page covers outbound Alpha/Radar webhooks, where Gigabrain sends events to your endpoint. To send external events into a SuperAgent, see [SuperAgent Custom Events](/developers/superagents-custom-events).
</Note>
...
Signature verification is optional, but recommended before trusting or processing webhook payloads. Store the signing secret when you create the webhook. It is shown only once.

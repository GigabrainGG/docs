...
<Note>
This page covers outbound Alpha/Radar webhooks, where Gigabrain sends events to your endpoint. To wake up a SuperAgent from external events, see [SuperAgent Triggers](/developers/superagents-triggers).
</Note>
